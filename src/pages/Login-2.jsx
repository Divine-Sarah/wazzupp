    ...
    <section className='flex flex-col justify-center items-center h-[100vh] background-image'>
        <div className='bg-white shadow-lg p-5 rounded-xl h-[27rem] w-[20rem] flex flex-col justify-center items-center'>
            ...
            <div className='w-full'>
                <input type="email" onChange={handleChangeUserData} name='email' className='border border-green-200 w-full outline-none p-2 rounded-md bg-[#01aa851d] text-[#004939f3] mb-3 font-medium placeholder:text-[#00493958]' placeholder='Email' />
                <input type="password" onChange={handleChangeUserData} name='password' className='border border-green-200 w-full outline-none p-2 rounded-md bg-[#01aa851d] text-[#004939f3] mb-3 font-medium placeholder:text-[#00493958]' placeholder='Password' />
            </div>
            <div className='w-full'>
